...
<meta name="keywords" 
content="Planet Hosting Responsive web template, Bootstrap Web Templates, 
Flat Web Templates, Android Compatible web template, Smartphone Compatible 
web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola 
web design" />
...
<link href='https://fonts.googleapis.com/css?family=Voltaire' 
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-header">
                            ...
                            <div class="navbar-brand">
                                <h1>
                                    <a href="index.php">Ced <span>Hosting</span></a>
                                </h1>
                            </div>
                        </div>
                                    ...
                                    <?php
                                        ...
                                        if ($result != 0) {
                                            foreach ($result as $html) {
                                                ...
                                                <li>
                                                <a 
                                                href="<?php echo $html['html']; ?>">
                                                <?php echo $html['prod_name']; ?>
                                                </a>
                                                </li>
                                                <?php
                                            }
