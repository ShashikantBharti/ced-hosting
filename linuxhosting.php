    ...
    <div class="linux-section">
        <div class="container">
            <div class="linux-grids">
                ...
                <h2>Linux Hosting</h2>
                <ul>
                    <li><span>Unlimited </span> 
                    Domains, Disk Space, Bandwidth and Email Addresses</li>

                    <li><span>99.9% uptime </span> 
                    with dedicated 24/7 technical support</li>

                    <li><span>Powered by </span> 
                    CloudLinux, cPanel (demo), Apache, MySQL, PHP, Ruby & more</li>

                    <li><span>Launch  </span> 
                    your business with Rs. 2000* Google AdWords Credit *</li>
            ...
            role="tabpanel" data-example-id="togglable-tabs">
                ...
                <ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
                    ...
                    <a href="#home" id="home-tab" role="tab" 
                        ...
                        aria-expanded="true">IN Hosting</a>
                    </li>

                    <li role="presentation"><a href="#profile" 
                        role="tab" id="profile-tab" data-toggle="tab" 
                        aria-controls="profile">US Hosting</a>
                    </li>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    id="home" aria-labelledby="home-tab">
                        <div class="linux-prices">
                            ...
                            $data = $query->getDataFrom(
                                'tbl_product', 
                                'tbl_product_description', 
                                ['id','prod_id'], '', '', 
                                ["tbl_product","prod_parent_id",
                                $id]
                            );
                            if ($data == 0) {
                                ...
                                <div class="col-md-3 linux-price">
                                    ...
                                    <div class="linux-bottom">
                                        ...
                                        <h6><?php echo $desc['free_domain']; ?> 
                                        Domain</h6>
                                        <ul>
                                            <li><strong><?php 
                                            echo $desc['web_space']; ?> 
                                            GB</strong> Disk Space</li>

                                            <li><strong><?php echo 
                                            $desc['band_width']; ?> 
                                            GB</strong> Data Transfer</li>

                                            <li><strong><?php echo 
                                            $desc['mail_box']; ?>
                                            </strong> Email Accounts</li>

                                            <li><strong><?php echo 
                                            $desc['technology']; ?>
                                            </strong> <br>Tech-Support</li>

                                            <li><strong>Includes 
                                            </strong>  Global CDN</li>

                                            <li><strong>High Performance
                                            </strong>  Servers</li>
