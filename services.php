<?php
/**
 * Service page to display all services.
 * 
 * PHP version 7
 * 
 * @category  Services.
        ...
        <div class="servicesprices-grids">
            <div class="col-md-4 servicesprices-grid">
                <div class="services-price">
                    ...
                    <p>
                        Bulum iaculis lacinia est. Proin dictum elemntum velit fusce 
                        euismod consequat ante lorem ipsum dolomet consectetuer
                    </p>
                    <ul>
